<div class="container-fluid mb-5">
    ...
    <h2 class="lead text-center"><i class="fas fa-cash-register fa-fw"></i> &nbsp; Nueva venta</h2>
    <hr>
</div>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <thead class="thead-dark">
                            ...
                            <tr>
                                ...
                                <th class="text-center text-white">Código de barras</th>
                                ...
                                <th class="text-center text-white">Actualizar</th>
                                <th class="text-center text-white">Remover</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            <div class="field has-addons mb-5">
                                ...
                                <div class="control">
                                    <a class="button is-danger" title="Remove cliente" id="btn_remove_client" onclick="remover_cliente(<?php echo $_SESSION['datos_cliente_venta']['cliente_id']; ?>)">
                                        <i class="fas fa-user-plus fa-fw tx-white"></i>
                                    </a>
                                </div>
                            </div>
                        <?php
